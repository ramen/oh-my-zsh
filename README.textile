...
@wget http://github.com/ramen/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/ramen/oh-my-zsh.git ~/.oh-my-zsh@
...
** Take a look at the "current themes":http://wiki.github.com/ramen/oh-my-zsh/themes that come bundled with _Oh My Zsh_.
